...
function generateStringFromCodePoint(code1, code2, code3, code4) {
  return String.fromCharCode(code1, code2, code3, code4); // Використовуємо String.fromCodePoint(), щоб створити рядок з символів code1, code2, code3, code4 на основі їх кодів Unicode
}
